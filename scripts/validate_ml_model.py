"""
ML Model Validation вЂ” Cross-Validation, Confusion Matrix, Leakage Check
...
Tests:
    ...
    3. Data leakage check вЂ” detect feature overlap between train/val
    4. Class distribution analysis вЂ” detect imbalance / synthetic bias
    5. Feature importance analysis вЂ” detect dominant features
    6. Calibration check вЂ” predicted probabilities vs actual
...
# в”Ђв”Ђ Feature extraction (copy from train_gb_model.py) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
# в”Ђв”Ђ Validation Sections в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
# в”Ђв”Ђ 1. Dataset Analysis в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def analyze_dataset(
    ...
    if imbalance_warning:
        print(f"  вљ  WARNING: Class imbalance ratio={ratio:.2f} вЂ” accuracy metric may be misleading!")
    else:
        print(f"  вњ“ Class balance is acceptable ({ratio:.2f})")
    ...
    if DATA_STATS.exists():
        ...
        if synthetic_pct > 40:
            print(f"  вљ  WARNING: {synthetic_pct:.0f}% synthetic data вЂ” HIGH leakage risk!")
            ...
            print(f"  вњ“ Synthetic data ratio is acceptable")
...
# в”Ђв”Ђ 2. Feature Analysis в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def analyze_features(
    ...
    if dominant_features:
        print(f"\n  вљ  Highly discriminative features (separation > 0.7):")
    ...
    # Feature variance check вЂ” zero-variance features are useless
    variances = np.var(X_train, axis=0)
    zero_var = [FEATURE_NAMES[i] for i in range(n_features) if variances[i] < 1e-6]
    if zero_var:
        print(f"\n  вљ  Zero-variance features (useless): {zero_var}")
    else:
        print(f"\n  вњ“ All features have non-zero variance")
...
# в”Ђв”Ђ 3. Model Loading and Basic Eval в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ

def load_model(model_path: Path):
    if not model_path.exists():
        print(f"  вњ— Model not found at {model_path}")
...
# в”Ђв”Ђ 4. Holdout Validation в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def holdout_validation(
    ...
    # Suspicion flags
    if acc > 0.99:
        print(f"  вљ  SUSPICIOUS: Accuracy {acc:.4f} > 99% is extremely high")
        print(f"    Possible causes:")
        print(f"    a) Data leakage вЂ” features are same as used to generate synthetic data")
    ...
    if auc > 0.999:
        print(f"  вљ  SUSPICIOUS: ROC-AUC {auc:.4f} в‰€ 1.0 вЂ” near-perfect discrimination")
...
# в”Ђв”Ђ 5. Cross-Validation в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def cross_validate(
    ...
    if acc_cv_std > 0.02:
        print(f"\n  вљ  High accuracy variance across folds: std={acc_cv_std:.4f}")
        ...
        print(f"\n  вљ  Very high mean accuracy ({np.mean(scores_acc):.4f}) with low variance ({acc_cv_std:.4f})")
        print(f"    This suggests the dataset itself is too easy вЂ” features perfectly separate classes.")
        print(f"    Root cause: synthetic data generation uses the same keyword lists as features.")
    else:
        print(f"\n  вњ“ Cross-validation scores look consistent")
...
# в”Ђв”Ђ 6. Leakage Check в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def leakage_check(
    ...
    for i in range(X_train.shape[1]):
        ...
        flag = "вљ " if diff < 0.001 else " "  # suspiciously similar
        if diff < 0.001:
            high_similarity_count += 1
        print(f"  {flag} {name:33s}  {tm:10.4f}  {vm:10.4f}  {diff:8.4f}")

    if high_similarity_count > len(FEATURE_NAMES) * 0.6:
        print(f"\n  вљ  LEAKAGE WARNING: {high_similarity_count}/{len(FEATURE_NAMES)} features have")
        ...
        print(f"\n  вњ“ Feature distributions differ between train and val (normal leakage level)")
    ...
    if overlap_pct > 30:
        print(f"  вљ  HIGH LEAKAGE: {overlap_pct:.1f}% of val feature vectors appear in train!")
        print(f"    The model has seen these exact feature patterns during training.")
    elif overlap_pct > 10:
        print(f"  вљ  MODERATE leakage: {overlap_pct:.1f}% overlap. May inflate metrics.")
    else:
        print(f"  вњ“ Low feature vector overlap ({overlap_pct:.1f}%)")
    ...
    if ratio_diff < 0.005:
        print(f"  вљ  Near-identical class ratios вЂ” likely stratified split from same pool")
        print(f"    This means train and val are NOT independent datasets.")
    else:
        print(f"  вњ“ Class ratios differ ({ratio_diff:.4f}) вЂ” reasonable split")
...
# в”Ђв”Ђ 7. Feature Importance в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def feature_importance(model, scaler, X_val: np.ndarray, y_val: np.ndarray) -> Dict[str, Any]:
    ...
    print(f"\n  {'Rank':>4}  {'Feature':35s}  {'Importance':>12}  {'В±Std':>8}")
    print(f"  {'-'*65}")
    ...
    if len(indices) > 0 and importance_mean[indices[0]] > 0.5:
        ...
        print(f"\n  вљ  DOMINANT FEATURE: '{dominant}' accounts for >{importance_mean[indices[0]]*100:.0f}% of model performance")
        print(f"    This suggests the model relies heavily on one feature вЂ” fragile in real-world use.")

    return {"top_features": top_features}


# в”Ђв”Ђ 8. Calibration Check в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def calibration_check(model, scaler, X_val: np.ndarray, y_val: np.ndarray) -> Dict[str, Any]:
    ...
    for i in range(n_bins):
        ...
        calibrated     = "вњ“" if error < 0.1 else "вљ "
    ...
    if mean_calib_error > 0.15:
        print(f"  вљ  Poorly calibrated: probabilities don't reflect actual frequencies")
    else:
        print(f"  вњ“ Model probabilities are reasonably calibrated")
    ...
    if extreme_pct > 90:
        print(f"  вљ  Model is extremely overconfident вЂ” nearly all predictions are near 0 or 1")
...
# в”Ђв”Ђ 9. Summary and Verdict в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
def print_verdict(
    ...
    if synthetic_pct > 40:
        ...
        recommendations.append(
            "Use stratified split by SOURCE вЂ” train on real events, validate on synthetic (not random split)"
        )
    ...
    if leakage_verdict in ("HIGH", "MEDIUM") or overlap_pct > 20:
        ...
        recommendations.append(
            "Data generation (augment_data.py) uses same keyword patterns as feature extraction вЂ” "
            "synthetic malicious events are trivially separable. Use adversarial examples or vary syntax."
        )

    if acc > 0.99:
        issues.append(f"[HIGH] Accuracy {acc:.4f} > 99% вЂ” unrealistically high for real-world threat detection")
        recommendations.append(
    ...
    if not issues:
        print(f"  вњ“ No critical issues found")
    else:
        for issue in issues:
            print(f"  вњ— {issue}")
    ...
    if not recommendations:
        print(f"  вњ“ Model appears production-ready")
    else:
    ...
    if len([i for i in issues if "CRITICAL" in i]) > 0:
        verdict = "NOT PRODUCTION READY вЂ” Critical leakage detected"
    elif len([i for i in issues if "HIGH" in i]) >= 2:
        verdict = "CAUTIOUS вЂ” High leakage risk, metrics inflated in lab, likely lower in production"
    elif issues:
        verdict = "ACCEPTABLE for prototype вЂ” monitor performance on real events"
    else:
